<template>
	...
	>
		<v-card>
			...
			<div class="d-flex">
				<v-img transition=none src="../assets/logo.png" width="30" class="ma-8"></v-img>
				<v-img transition=none src="../assets/logo2.png" width="70" class="ma-1"></v-img>
			</div>
			...
			<v-img transition=none src="../assets/person.png" width="100" class="ma-auto"></v-img>
